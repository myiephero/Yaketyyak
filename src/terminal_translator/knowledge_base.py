...
KNOWLEDGE_BASE: Dict[str, Dict[str, str]] = {
    ...
    "pwd": {
        "beginner": "This shows where you are right now - the full path to your current folder. It stands for 'print working directory'. Very useful when you're lost or want to confirm you're in the right place.",
        "familiar": "Print working directory - shows the absolute path of your current location."
    },
    "echo": {
        "beginner": "This prints text to the screen. 'echo Hello' shows 'Hello'. Often used to display messages or create files: 'echo \"text\" > file.txt'. Also useful to see the value of variables: 'echo $HOME'.",
        "familiar": "Outputs text to stdout. Use with > to write to files, >> to append. Display variables with $VAR."
    },
    "man": {
        "beginner": "This opens the manual (help pages) for any command. 'man ls' shows detailed documentation for the ls command. Use arrow keys to scroll, and press 'q' to quit. It's like a built-in help system.",
        "familiar": "Displays manual pages for commands. Press q to quit, / to search within."
    },
    "which": {
        "beginner": "This tells you where a program is located on your computer. 'which python' shows the path to the python executable. Useful for debugging when you have multiple versions installed.",
        "familiar": "Locates a command's executable in PATH. Useful for verifying which version of a tool is active."
    },
    "clear": {
        "beginner": "This clears your terminal screen, giving you a fresh, empty view. Your command history is still there - you can scroll up or press the up arrow to see previous commands. It just cleans up the display.",
        "familiar": "Clears the terminal display. History preserved. Keyboard shortcut: Ctrl+L."
    },
...
PATTERN_MATCHERS = [
    ...
    {
        "pattern": r"\$\s*\w+",
        "beginner": "The $ symbol followed by a word is a variable in the shell. For example, $HOME is your home directory, $PATH is where the computer looks for programs. To see a variable's value, use 'echo $VARNAME'.",
        "familiar": "Shell variable. Common vars: $HOME, $PATH, $USER. View with 'echo $VAR', set with 'export VAR=value'."
    },
]
...
def lookup(text: str, mode: str = "beginner") -> Optional[Dict]:
    ...
    # 1. Direct match in knowledge base (sorted by length, longest first)
...
def get_all_patterns() -> List[Dict]:
    """Returns all patterns for display."""
    patterns = []
